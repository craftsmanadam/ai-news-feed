...
PRIORITY_TAG = Literal["must_read", "worth_a_glance", "breaking", "falling", "evergreen"]
...
class Source(BaseModel):
    ...
    reliability_score: int = Field(default=5, ge=1, le=10, description="Agent's assessment of source credibility (1-10)")
...
class DailyBrief(BaseModel):
    date: datetime = Field(
        ..., description="ISO 8601 formatted date of brief"
    )
